...
import { TransactionContext } from '../context/TransactoContext';
    ...
    return (
        ...
        '>
            <div className='flex flex-col items-center w-full mt-3'>
                ...
                <a href={`https://ropsten.etherscon.io/address/${addressFrom}`}
                target="_blank" rel="noopener noreferrer">
                    <p className='text-white text-base'>From: {shortenAddress(addressFrom)}</p> 
                </a>
                <a href={`https://ropsten.etherscon.io/address/${addressTo}`}
                target="_blank" rel="noopener noreferrer">
